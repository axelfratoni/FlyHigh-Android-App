            ...
            public boolean onQueryTextSubmit(String query) {
                if (query.matches(".+-\\d+")) {
                    ...
                    if (coordinatorLayout != null) {
                        Snackbar.make(coordinatorLayout, getResources().getString(R.string.not_a_flight_code), Snackbar.LENGTH_SHORT).show();
                    }
                }
                return false;
            }
    ...
    private class flyRetriever extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null && stat != null) {
                ...
                CoordinatorLayout coordinatorLayout = (CoordinatorLayout) view.findViewById(R.id.coordinator_layout);
                if (coordinatorLayout != null) {
                    Snackbar.make(coordinatorLayout, getResources().getString(R.string.flight_not_found), Snackbar.LENGTH_SHORT).show();
                }
            }
        }
    }
